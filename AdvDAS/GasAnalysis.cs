    ...
    class GasAnalysis
    {
        ...
        public void newEntry(string note)
        {
            ...
            try
            {
                    ...
                    sqlite_cmd.CommandText = "INSERT INTO Readings (O2,CO, CO2, NO, NO2, NOx, SO2, CxHy, Tgas, Tamb, Tcell, Efficiency, IFlow, Draft, Losses, ExcessAir, COmass, NOxmass, Notes) VALUES ('"
